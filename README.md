...
This script is designed to simplify the deployment and management of a Dungeon Crawl Stone Soup server. It includes as many fork versions as possible (DCSS CA, HellCrawl, Housing, GnollCrawl, B-Crawl, BloatCrawl2, GoonCrawl, X-Crawl, StoatSoup, BcadrenCrawl, KimchiCrawl, AddedCrawl, DCST, YiufCrawl, Stone Soup Nostalgia, OOFCrawl, BoggartCrawl) and official release versions (0.11 ~ 0.34) in a latest Ubuntu image environment.
