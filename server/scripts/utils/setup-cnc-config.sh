...
sed -i 's|<script type="text/javascript">|<script  type="text/javascript">\
      ...
      localStorage.DWEM_MODULES = JSON.stringify(\
        ["io-hook", "site-information", "websocket-factory", "rc-manager", "command-manager", "module-manager", "cnc-banner", "cnc-userinfo", "sound-support", "cnc-chat", "cnc-public-chat", "cnc-event", "convenience-module", "cnc-splash-screen", "wtrec", "advanced-rc-editor", "translation-module", "map-predictor"].map(m => "../modules/" + m + "/index.js")\
      );|g' "$WEBDIR/templates/client.html"
sed -i 's|"cnc-public-chat", "convenience-module"|"cnc-public-chat", "cnc-event", "convenience-module"|g' "$WEBDIR/templates/client.html"
sed -i 's|"translation-module"].map(m =>|"translation-module", "map-predictor"].map(m =>|g' "$WEBDIR/templates/client.html"
